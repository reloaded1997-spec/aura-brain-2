    ...
    <div className="min-h-full bg-[#FAF8F3] dark:bg-[#171511] pb-8">
      ...
      <div className="px-[22px] pt-14 pb-[18px]">
        ...
        <div className="flex items-center gap-[15px]">
          <div
            className={`flex h-[62px] w-[62px] flex-shrink-0 items-center justify-center bg-[#ECE7DB] dark:bg-[#2C2820] font-['Newsreader'] text-[28px] text-[#6F6A60] dark:text-[#A39C8E] ${
          ...
          <div className="min-w-0">
            <div className="font-['Newsreader'] text-[29px] leading-[1.05] text-[#1F1D18] dark:text-[#F1EDE5]">
              {profile?.name}
            </div>
            {role && <div className="mt-[3px] text-[13px] text-[#6F6A60] dark:text-[#A39C8E]">{role}</div>}
          </div>
        </div>
      ...
      <div className="px-4 pb-5">
        <div className="mx-1 mb-[9px] flex items-center gap-2">
          ...
          {saved && (
            <span className="text-[11px] italic text-[#9A958A] dark:text-[#827C70]">Saved</span>
          )}
        </div>
        <textarea
          ref={notesRef}
          ...
          className="w-full resize-none rounded-[20px] border border-[#EBE6DC] dark:border-[#322E27] bg-white dark:bg-[#221F1B] px-[15px] py-[13px] font-['Newsreader'] text-[15px] text-[#26241F] dark:text-[#ECE7DD] placeholder:text-[#B0AB9E] dark:placeholder:text-[#6E685D] focus:border-[#D8B98E] focus:outline-none min-h-[80px]"
        />
      </div>
        ...
        <div className="overflow-hidden rounded-[20px] border border-[#EBE6DC] dark:border-[#322E27] bg-white dark:bg-[#221F1B] shadow-[0_1px_2px_rgba(40,36,31,0.03)] dark:shadow-[0_1px_2px_rgba(0,0,0,0.32)]">
          {activeRequests.map((r) => (
            <button
              ...
              className="flex w-full items-start gap-3 border-b border-[#F1ECE2] dark:border-[#272320] px-[15px] py-[14px] text-left"
            >
              <span className="mt-[1px] flex h-[22px] w-[22px] flex-shrink-0 items-center justify-center rounded-full border-[1.5px] border-[#D2CBBC] dark:border-[#46413A] bg-transparent" />
              <span className="flex-1 pt-[1px] text-[14.5px] leading-[1.4] text-[#3A372F] dark:text-[#D6D1C6]">
                {r.text}
              </span>
            </button>
          ))}
      ...
      {showAnswered && answeredRequests.length > 0 && (
        <div className="px-4 pt-5">
          <button
            ...
            className="mx-1 mb-[9px] flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[1.8px] text-[#9A958A] dark:text-[#827C70]"
          >
            Answered prayers
            <ChevronDown
            ...
            <div className="overflow-hidden rounded-[20px] border border-[#EBE6DC] dark:border-[#322E27] bg-white dark:bg-[#221F1B] shadow-[0_1px_2px_rgba(40,36,31,0.03)] dark:shadow-[0_1px_2px_rgba(0,0,0,0.32)]">
              {answeredRequests.map((r) => (
                <button
                  ...
                  type="button"
                  onClick={() => onToggleRequest(r.id)}
                  className="flex w-full items-start gap-3 border-b border-[#F1ECE2] dark:border-[#272320] px-[15px] py-[14px] text-left last:border-b-0"
                >
                  <span className="mt-[1px] flex h-[22px] w-[22px] flex-shrink-0 items-center justify-center rounded-full border-[1.5px] border-[#5F7F67] dark:border-[#80A789] bg-[#5F7F67] dark:bg-[#80A789]">
                    <Check className="h-3 w-3 text-white" strokeWidth={2.6} />
                  </span>
                  <span className="flex-1 pt-[1px] text-[14.5px] leading-[1.4] text-[#9A958A] dark:text-[#827C70] line-through">
                    {r.text}
                  </span>
                </button>
              ))}
      ...
      {/* ---- Relational log ---- */}
      <div className="px-4 pt-6">
        <div className="mx-1 mb-3 text-[10px] font-semibold uppercase tracking-[1.8px] text-[#9A958A] dark:text-[#827C70]">
          Relational log
        </div>
              ...
              <div key={entry.id} className="flex gap-[13px] px-1 pb-4">
                ...
                <div className="flex flex-shrink-0 flex-col items-center">
                  <span
                    className={`mt-[5px] h-[9px] w-[9px] rounded-full ${
                      entry.fromJournal ? 'bg-[#5F7F67] dark:bg-[#80A789]' : 'bg-[#D7CFBF] dark:bg-[#3A352C]'
                    }`}
                  />
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-[12px] text-[#9A958A] dark:text-[#827C70]">{entry.date}</span>
                    {entry.fromJournal && (
                      <span className="rounded-full bg-[#EEF3EC] dark:bg-[#1B2620] px-2 py-[2px] text-[10px] font-semibold tracking-[0.3px] text-[#5F7F67] dark:text-[#80A789]">
                        FROM JOURNAL
                      </span>
                    )}
                  </div>
                  <div className="mt-[5px] text-[14.5px] leading-[1.5] text-[#3A372F] dark:text-[#D6D1C6]">
                    {entry.text}
                  </div>
                </div>
              </div>
